...
- Widget: `<script src=".../widget.js" data-key="…">` abre o chat em iframe (`/w/[key]`), funciona em qualquer site.
- Afiliados: link `?ref=`, cookie de 30 dias, 30% recorrente calculado no webhook do Stripe.
...
2. **SQL Editor** → cole e execute `supabase/migrations/0001_init.sql`. Ele cria tabelas, pgvector, funções, RLS, buckets e a agência "vitrine" que hospeda as demos anônimas da landing.
...
src/app/
  ...
  api/chat · api/demo · api/leads · api/bots/[id]/sources · api/stripe/*
public/widget.js                    loader do widget (botão flutuante + iframe)
```
